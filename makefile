...
solver: $(SDIR)/Solver.h $(SDIR)/Solver.cpp $(SDIR)/StdRepresentative.h $(SDIR)/StdRepresentative.cpp $(SDIR)/Heuristic.h $(SDIR)/Heuristic.cpp
...
main: $(MDIR)/Main.cpp $(MDIR)/Marcio_SandBox.cpp $(MDIR)/Fabio_SandBox.cpp tools solver
	...
	g++ -Wextra -ansi -O3 -funroll-all-loops -DIL_STD $(INCCPLEX) $(CONCPLEX) lib/time.o lib/set.o lib/graph.o lib/reader.o lib/heur.o lib/solver.o lib/stdrepr.o $(MDIR)/Main.cpp -o bin/main $(LIBCPLEX)	
	g++ -Wextra -ansi -O3 -funroll-all-loops -DIL_STD $(INCCPLEX) $(CONCPLEX) lib/time.o lib/set.o lib/graph.o lib/reader.o lib/heur.o lib/solver.o lib/stdrepr.o $(MDIR)/Marcio_SandBox.cpp -o bin/marcio $(LIBCPLEX)
	g++ -Wextra -ansi -O3 -funroll-all-loops -DIL_STD $(INCCPLEX) $(CONCPLEX) lib/time.o lib/set.o lib/graph.o lib/reader.o lib/heur.o lib/solver.o lib/stdrepr.o $(MDIR)/Fabio_SandBox.cpp -o bin/fabio $(LIBCPLEX)